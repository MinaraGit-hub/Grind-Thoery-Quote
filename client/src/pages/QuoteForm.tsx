...
export default function QuoteForm() {
  ...
  useEffect(() => {
    ...
    const handler = (e: MouseEvent) => {
      const clickedBtn = calendarRef.current?.contains(e.target as Node);
      const clickedPopup = calendarPopupRef.current?.contains(e.target as Node);
              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="space-y-4 md:space-y-6">
                  ...
                  {calendarOpen && createPortal(
                    ...
                    >
                      <div
                        className="bg-[#4a3f35] border border-white/20 rounded-2xl shadow-2xl p-3"
                        style={{
